<template>
    <a class="social-link" :href="props.link" @mouseover="hoverOverLink(true)" @mouseleave="hoverOverLink(false)">
      <img :src="props.image" :alt="props.name" class="social-link__image" rel="preload" ref="socialLinkImage" />
    </a>
</template>
